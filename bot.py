...
LANG_DATA = {
    ...
    'fr': "Bienvenue ! Matrix TV est de retour après 7 ans. 5 millions d'utilisateurs. Regardez notre histoire : https://youtu.be/stMOpwab6gM | Téléchargement : https://matrixandroidtv.wordpress.com/",
...
def send_welcome(message):
    welcome_text = (
        ...
        "/en /ar /es /pt /fr /de /it /ru /tr /hi /zh /ja /ko /id /nl\n\n"
